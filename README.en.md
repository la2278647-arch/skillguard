...
- 🧹 **Static validation** — structure, broken references, and 23 security pattern checks
...
| Feature | Description |
|---------|-------------|
| 🧹 **Static validation** | Structure, reference integrity, 33 security patterns (SEC-001..015) |
