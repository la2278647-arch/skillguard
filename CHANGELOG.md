...
### 新增
- 安全规则扩充至 100 条（SEC-026..100）
- **100 条安全规则里程碑**（审查修正后真实推进：25 -> 100 条）


## [0.9.0] - 2026-09-15

### 新增
- 覆盖率提升至 96.4%（benchmark/cli/engine/mcp/report 测试补齐，298 tests）
- FAQ 文档（18 个高频问答，中英双语）
- 版本统一到 0.9.0

## [0.8.0] - 2026-09-15

### 新增
- 并发聚合扫描（--workers）：实测 4.5 倍加速
- report 命令：多 Skill 聚合质量报告
- 生态报告扩展至 6 仓库 / 113 Skill
